                ...
                <li class="tocify-item level-1" data-unique="usuario">
                    <a href="#usuario">Usuario</a>
                                ...
                                <a href="#usuario-GETapi-user-users-all">Obtener todos los usuarios</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="usuario-POSTapi-user-create-user">
                                <a href="#usuario-POSTapi-user-create-user">Crear un nuevo usuario</a>
                            </li>
...
<p>Bienvenido a la documentación de la API de Laravel. Aquí encontrarás toda la información necesaria para interactuar con nuestra API BASICA .</p>
<aside>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="usuario-POSTapi-user-create-user">Crear un nuevo usuario</h2>
...
<span id="example-requests-POSTapi-user-create-user">
<blockquote>Example request:</blockquote>
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost/api/user/create-user';
$response = $client-&gt;post(
    $url,
    [
        'headers' =&gt; [
...
<span id="example-responses-POSTapi-user-create-user">
</span>
<span id="execution-results-POSTapi-user-create-user" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-user-create-user"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-user-create-user"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-user-create-user" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-user-create-user">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-user-create-user" data-method="POST"
      data-path="api/user/create-user"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-user-create-user', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-user-create-user"
                    onclick="tryItOut('POSTapi-user-create-user');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-user-create-user"
                    onclick="cancelTryOut('POSTapi-user-create-user');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-user-create-user"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/user/create-user</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-user-create-user"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-user-create-user"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-user-create-user"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="POSTapi-user-create-user"
               value="b"
               data-component="body">
    <br>
<p>Nombre completo del usuario. El campo value no debe ser mayor que 255 caracteres. Example: <code>b</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>email</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="email"                data-endpoint="POSTapi-user-create-user"
               value="zbailey@example.net"
               data-component="body">
    <br>
<p>Correo electrónico del usuario. El campo value no es un correo válido. Example: <code>zbailey@example.net</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="password"                data-endpoint="POSTapi-user-create-user"
               value="-0pBNvYgxw"
               data-component="body">
    <br>
<p>Contraseña del usuario. El campo debe contener al menos 6 caracteres. Example: <code>-0pBNvYgxw</code></p>
        </div>
        </form>
